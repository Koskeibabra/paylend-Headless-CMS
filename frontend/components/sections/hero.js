...
const Hero = ({ data }) => {
  return (
    <main className="container flex flex-col md:flex-row items-center justify-between py-12 font-serif h-max">
      ...
      <div className="flex-shrink-0 w-full md:w-7/12 mt-6  md:mt-0">
